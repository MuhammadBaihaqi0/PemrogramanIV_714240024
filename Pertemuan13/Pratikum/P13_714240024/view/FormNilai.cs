...
namespace P9_714240024.view
{
    public partial class FormNilai : Form
    {
        ...
        public void GetDataMhs()
        {
            ...
            MySqlDataReader reader = koneksi.reader1("SELECT npm FROM t_mahasiswa");
            while (reader.Read())
            {
        ...
        private void textBoxCariData_TextChanged(object sender, EventArgs e)
        {
            ...
            string sql =
                "SELECT id_nilai, matkul, kategori, t_nilai.npm, nama, nilai " + "FROM t_nilai JOIN t_mahasiswa ON t_mahasiswa.npm = t_nilai.npm " + "WHERE CAST(t_nilai.npm AS CHAR) LIKE @param " + "OR nama LIKE @param " + "OR matkul LIKE @param";
