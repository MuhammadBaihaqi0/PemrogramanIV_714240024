...
namespace P9_714240024.view
{
    public partial class ParentForm : Form
    {
        ...
        private void tugasOToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void dataTranksaskiToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormTranksaksi FrmTranksaksi = new FormTranksaksi();
            FrmTranksaksi.MdiParent = this;
            FrmTranksaksi.Show();
        }
